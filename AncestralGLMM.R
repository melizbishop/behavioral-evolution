...
#tt="(santomea:0.53,((sechelia:0.15,simulans:0.15,mauritiana:0.15)oldsim:0.14,melanogaster:0.29)oldmela:0.24);"
#tt="((yakuba:0.09,santomea:0.09)oldyasa:0.44,((sechelia:0.15,simulans:0.15)oldsim:0.14,melanogaster:0.29)oldmela:0.24);"
#tt="((yakuba:0.09,santomea:0.09)oldyasa:0.44,((sechelia:0.15,mauritiana:0.15)oldsim:0.14,melanogaster:0.29)oldmela:0.24);"
#tt="((yakuba:0.09,santomea:0.09)oldyasa:0.44,(sechelia:0.15,simulans:0.15,mauritiana:0.15)oldsim:0.38);"
#tt="((yakuba:0.09,santomea:0.09)oldyasa:0.44,((sechelia:0.15,simulans:0.15)oldsim:0.14,melanogaster:0.29)oldmela:0.24);"
...
#LFlydat <- read.table("../../data/logDatFlyLapSmoothAllNewNames.txt", header=TRUE, sep="\t", row.names="id")
#LFlydat <- read.table("logDatFlyLapSmoothAllNewNames.txt", header=TRUE, sep="\t", row.names="id")
#LFlydat <- read.table("../../data/logDatFlyLapSmoothAllMinusYakNewNames.txt", header=TRUE, sep="\t", row.names="id")
